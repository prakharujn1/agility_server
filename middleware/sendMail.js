...
const sendForgotMail = async(subject, data) => {
    ...
    <body>
      <div class="container">
        ...
        <p>Hello,</p>
        <p>You have requested to reset your password. Please click the button below to reset your password.It is valid for 10 minutes</p>
        <a href="${process.env.frontendurl}/reset-password/${data.token}" class="button">Reset Password</a>
        <p>If you did not request this, please ignore this email.</p>
        <div class="footer">
          <p>Thank you,<br>AgilityAI Team</p>
          <p><a href="${process.env.frontendurl}"></a></p>
        </div>
      </div>
    </body>
    </html>
